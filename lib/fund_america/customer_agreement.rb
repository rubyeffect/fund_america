module FundAmerica
  class CustomerAgreement
    class << self
      ...
      def edit(entity_id)
        API::request(:get, FundAmerica.base_uri + "entities/#{entity_id}/customer_agreement/edit")
      end
      ...
      def update(entity_id, options)
        API::request(:patch, FundAmerica.base_uri + "entities/#{entity_id}/customer_agreement", options)
      end
