module FundAmerica
  class TechServicesAgreement
    class << self
      ...
      def list
        API::request(:get, 'tech_services_agreements')
      end
      ...
      def create(options)
        API::request(:post, 'tech_services_agreements', options)
      end
      ...
      def details(tech_services_agreement_id)
        API::request(:get, "tech_services_agreements/#{tech_services_agreement_id}")
      end
